		...
		<div className={Style.post}>
			<div className={Style.postHead}>
				<img
					...
					src="https://images.unsplash.com/photo-1577475766758-21071075ff92?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80"
					alt=""
				/>
				...
				<div className={Style.info}>
					...
					<div className={Style.infoRight}>
						<span className={Style.timePosted}>4 mins ago</span>
